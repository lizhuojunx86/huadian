...
> 详见 `kb_forge/sprint-templates/stop-rules-catalog.md` 5 类模板。
...
## 8. D-route 资产沉淀预期（D-route 风格项目适用 — 详见 `kb_forge/README.md` D-route 段；非 D-route 项目可删本节）
...
**本 brief 模板版本**：kb_forge/sprint-templates v0.1.5
