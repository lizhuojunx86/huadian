...
每次会话启动必执行（参见 `kb_forge/role-templates/tagged-sessions-protocol.md` §3 启动模板通用版）：
...
每次会话结束必更新（参见 `kb_forge/role-templates/tagged-sessions-protocol.md` §4 收尾模板通用版）：
...
参见 `kb_forge/role-templates/cross-domain-mapping.md`。

---

**本模板版本**：kb_forge/role-templates v0.1
