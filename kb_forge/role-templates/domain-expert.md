...
详见 `kb_forge/role-templates/cross-domain-mapping.md`。
...
```bash
cp kb_forge/role-templates/domain-expert.md \
...
参见 `kb_forge/role-templates/cross-domain-mapping.md` 完整 6 领域速查表。
