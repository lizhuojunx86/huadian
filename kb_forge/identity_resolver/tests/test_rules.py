"""Tests for kb_forge.identity_resolver.rules — R1/R3/R4/R5 + score_pair + context."""

from __future__ import annotations

import re

from kb_forge.identity_resolver import EntitySnapshot, build_score_pair_context
from kb_forge.identity_resolver.rules import (
    DEFAULT_RULE_ORDER,
