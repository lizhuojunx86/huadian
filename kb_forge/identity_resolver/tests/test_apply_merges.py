"""Tests for kb_forge.identity_resolver.apply_merges — filter helper."""

from __future__ import annotations

from kb_forge.identity_resolver import MergeGroup, MergeProposal
from kb_forge.identity_resolver.apply_merges import filter_groups_by_skip_rules
from kb_forge.identity_resolver.types import MatchResult
