"""Tests for kb_forge.identity_resolver.guards — chain dispatch + payload swap."""

from __future__ import annotations

from kb_forge.identity_resolver import EntitySnapshot, GuardResult
from kb_forge.identity_resolver.guards import evaluate_pair_guards
from kb_forge.identity_resolver.utils import swap_ab_payload
