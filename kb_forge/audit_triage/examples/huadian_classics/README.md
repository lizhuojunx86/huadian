...
| `kb_forge.audit_triage.service.record_decision` | `recordTriageDecision` orchestration (line 763) |
| `kb_forge.audit_triage.service.encode_item_id` | `encodeTriageItemId` (line 78) |
| `kb_forge.audit_triage.service.decode_item_id` | `decodeTriageItemId` (line 85) |
...
跨域 mapping 的更详细指南见 `kb_forge/audit_triage/cross-domain-mapping.md`（Sprint Q 批 3 起草）。
...
PYTHONPATH=$(pwd) DATABASE_URL=postgresql://huadian:huadian_dev@localhost:5433/huadian \
    ...
    -m kb_forge.audit_triage.examples.huadian_classics.test_soft_equivalent
```
