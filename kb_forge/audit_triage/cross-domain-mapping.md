...
- approve guard_blocked_merge → 调用 MergeApplier (kb_forge/identity_resolver) merge persons + 写 merge_log
...
把 `kb_forge/audit_triage/examples/huadian_classics/` 复制为 `examples/your_domain/` 后：
