# kb_forge/audit_triage — Audit Trail + Triage Workflow Framework
...
```python
import asyncpg
from kb_forge.audit_triage import (
    StaticAllowlist, DefaultReasonValidator,
    RecordDecisionInput, record_decision,
)
from kb_forge.audit_triage.examples.huadian_classics import (
    AsyncpgTriageStore,
)
...
> 第四刀 (O)：kb_forge/invariant_scaffold/
> 第五刀 (Q)：kb_forge/audit_triage/ ← 本框架
