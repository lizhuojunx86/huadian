...
Usage:
    ...
    PYTHONPATH=$(pwd) DATABASE_URL=... \\
      ...
      python -m kb_forge.invariant_scaffold.examples.huadian_classics.test_byte_identical
...
from kb_forge.invariant_scaffold.examples.huadian_classics.db_port import (
    HuaDianAsyncpgPort,
)
from kb_forge.invariant_scaffold.examples.huadian_classics.runner_setup import (
    build_huadian_runner,
    build_huadian_self_test_runner,
)
from kb_forge.invariant_scaffold.examples.huadian_classics.self_tests import (
