# kb_forge/invariant_scaffold — Invariant Checking Framework
...
# → from huadian.kb_forge.invariant_scaffold import ...
```
...
from kb_forge.invariant_scaffold import DBPort
...
```python
from kb_forge.invariant_scaffold import (
    InvariantRunner,
    UpperBoundInvariant,
    LowerBoundInvariant,
...
```python
from kb_forge.invariant_scaffold import SelfTest, SelfTestRunner
...
| **v0.3.0** | **2026-04-30** | **Sprint T v0.3 release** | 内容无独立 patch；与 framework v0.3 release 同步发布（统一版本号策略 / pytest tests 套件已在 Sprint Q 落地 27 tests）|

---

> 本框架是 AKE 框架 Layer 1 的**第四刀**。
> 第一刀 (L)：kb_forge/sprint-templates/
> 第二刀 (M)：kb_forge/role-templates/
> 第三刀 (N)：kb_forge/identity_resolver/
> 第四刀 (O)：kb_forge/invariant_scaffold/ ← 本框架
