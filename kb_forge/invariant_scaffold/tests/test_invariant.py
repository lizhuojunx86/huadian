"""Tests for kb_forge.invariant_scaffold.invariant — ABC + run() wrapping."""

from __future__ import annotations

import pytest

from kb_forge.invariant_scaffold import Invariant
from kb_forge.invariant_scaffold.port import DBPort
from kb_forge.invariant_scaffold.types import Violation
