...
| L2 方法论文档 | 🟢 **8 doc 完整 + methodology v0.2 cycle 完成 8/8 = 100% ⭐⭐⭐ + 维护态首批 v0.2.1 patch (2 doc)**：/00 v0.2 + /01 v0.2 + **/02 v0.2.1** (Sprint AA §14.4+§15.4 cross-ref polish) + /03 v0.2 + **/04 v0.2.1** (Sprint AA fold §8.6 实证+反模式) + /05 v0.2 + /06 v0.2 + /07 v0.2 + **/08 v0.3 partial（GO-K-ε §7.3 学术理论 5 锚点展开 / case-2 应用层）⭐⭐⭐** + **/09 v0.2 全本（GO-J-ε 950 行 / 4 mermaid / case-2 应用层）⭐⭐⭐** + **decision-journals/ Q5 ACK 节律首篇 2026-05.md v1.0 定版 ⭐⭐⭐**（GO-L-ε / 用户审稿通过 / 协作闭环首次实证） | Layer 2 维护态运行中；4 类工作流 3/4 已实证；**case-2 应用层文章组（08+09）进入 v0.3 启动阶段 / 双文章节奏一致 / D-route §6 2026-10 v1.0 发布锚点领先 ~6-8 周** ⭐ |
| L3 案例库 | 🟢 主案例 + demo + 5 sprint dogfood + Sprint Q dogfood ✅ user local + Sprint T Docker dogfood ✅ sandbox PASSED + **case-2 中药提取 GO-A → GO-M-ζ 16 阶段 ⭐⭐⭐**（双产品 / 28 物料 / 12 批 / 4 fundamental findings F-001~F-004 / 22 anomalies / **3 ADR (033/034/035)** / 应用层方法论 08 v0.3 partial + 09 v0.2 全本 双文章配对完整 / **schema v0.4 outline lock (8 项 / 押后 3 项 v0.5)**） | 沉淀期 (5/15→5/31) 并行项 D5 ✅ / **case-2 应用层文章组（08 + 09）按 D-route §6 2026-10 双文章 v1.0 发布锚点推进 / 当前领先 ~6-8 周**（v0.2 全本提前从 6 月节点达成 / GO-I-ε + GO-J-ε 5/14 双批 / GO-K-ε 08 v0.3 启动 / GO-L-ε 月度日记 v1.0 / GO-M-ζ ADR-035 + schema v0.4 outline）|
