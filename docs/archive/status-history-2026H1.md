...
## 原 §5 ~ §7 及 Phase 0 遗留段（已完成 / 进行中 / 下一步候选 / 阻塞项 / 最近决策 / 健康度指标 / 更新日志 / 技术债索引）
