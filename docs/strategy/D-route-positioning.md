...
|  | 取知识（已造好的）| 造知识（从零造）|
|---|---|---|
| **单人 / 小团队** | LangChain / LlamaIndex / RAG 类工具 | shiji-kb / 鲍捷 SKILL |
...
| 2026-10 (6mo) | 第 1-2 篇方法论文章发布 + 与鲍捷有过 1 次实质交流 | 写作节律 (Q5) 不掉链 |
...
| 风险 | 概率 | 严重度 | 对策 |
|------|------|-------|------|
| shiji-kb 团队抢做团队级框架 | 低 | 高 | 持续观察社区动向；与鲍捷建立友好关系；保持差异化（团队 vs 单人） |
...
| 2026-05-30 | （可选）观察数字人文 19 群 4 周后 → 决定何时主动接触鲍捷 | User |
