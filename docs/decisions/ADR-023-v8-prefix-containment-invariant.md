...
- **Related**:
  ...
  - T-P1-021（canonical merge missed pairs — 本 ADR probe 顺手发现，单独追踪）
...
- **副产品**：probe 暴露疑似 canonical merge 遗漏（管叔 vs 管叔鲜，蔡叔 vs 蔡叔度）→ T-P1-021

---

## 6. Known Follow-ups

- **T-P1-021**（本 ADR probe 发现）：canonical merge missed pairs（管叔/管叔鲜, 蔡叔/蔡叔度）需 ADR-014 execution model 覆盖处理
