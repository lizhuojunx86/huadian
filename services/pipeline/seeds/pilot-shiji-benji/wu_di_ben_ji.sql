...
-- Generated: 2026-04-18T03:05:33.782977+00:00
-- Book ID: b824a426-1063-4d03-8276-4ca083ddbd4b
-- Prompt: ner/v1
...
-- Person: 伯夷 (bo-yi)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('ec440301-5a6f-4d5b-86bf-1f1dabcaf5ff', 'bo-yi', '{"zh-Hans": "伯夷"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "受命为秩宗，掌三礼，后让于夔、龙 主掌礼仪，使上下皆能谦让"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 昌意 (chang-yi)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('1c404625-59ff-47a9-a239-097e432ad822', 'chang-yi', '{"zh-Hans": "昌意"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "黄帝次子，降居若水，娶蜀山氏女昌仆，生高阳 黄帝之子，颛顼之父 颛顼之父"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 丹朱 (dan-zhu)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('46add4d2-e583-449a-8ad4-2732b43b9618', 'dan-zhu', '{"zh-Hans": "丹朱"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "尧之嗣子，被放齐举荐，尧以其顽凶而否定 尧之子，因不肖未获授天下，诸侯讼者皆归舜而不归之 尧之子，舜丧毕后让位于他，但天下归舜 尧之子，受封有疆土以奉先祀，以客礼见天子"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 皋陶 (gao-yao)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('041aef60-51bd-4509-88b2-d41969f80805', 'gao-yao', '{"zh-Hans": "皋陶"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "受命为士，掌五刑五流，维明能信 任大理之职，执法公平，民皆服其判决"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 鲧 (gun)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('2654bbc9-aa0e-4f85-b99b-2f593d08bc84', 'gun', '{"zh-Hans": "鲧"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "被四岳举荐治水，尧虽疑其负命毁族，仍听岳用之，九年功用不成 被四岳举荐治鸿水，治水无功，后被舜殛于羽山"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 后稷 (hou-ji)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('709a5ab7-7bb3-4091-a80f-d209caaf5a48', 'hou-ji', '{"zh-Hans": "后稷"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "受命播百谷以解黎民饥困"}'::jsonb) ON CONFLICT (slug) DO NOTHING;

-- Person: 黄帝 (huang-di)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('3197e202-55e0-4eca-aa91-098d9de33bc9', 'huang-di', '{"zh-Hans": "黄帝"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "少典之子，姓公孙名轩辕，自幼聪慧神灵 习用干戈征伐不服，战胜炎帝与蚩尤，被诸侯尊为天子 巡行四方、合符釜山、举贤治民，有土德之瑞故号黄帝 有二十五子，其中十四人得姓 居轩辕之丘，娶嫘祖为正妃，生玄嚣与昌意，崩后葬桥山 颛顼之祖父 帝喾之曾祖，玄嚣之父 国号有熊，与舜禹同姓，以章明德 百家多有记载，长老往往称其处，为五帝之首"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 夔 (kui)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('66f1ad60-8174-4ed9-b780-102df2a0609d', 'kui', '{"zh-Hans": "夔"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "受命为典乐，教化稚子，使神人和谐"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 商均 (shang-jun)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('34b568ad-7280-41fa-bd84-83a4d25f29f1', 'shang-jun', '{"zh-Hans": "商均"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "舜之子，不肖，舜因此荐禹于天，后受封有疆土以奉先祀"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 舜 (shun)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('f1a7e4d2-41fa-400c-881b-dfb4919e8200', 'shun', '{"zh-Hans": "舜"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "民间孝子，被众人举荐，尧以二女妻之以观其德，舜使二女守妇礼于妫汭 受尧考察，治百官、宾四门、历山林，三年后受禅于文祖 受尧命摄行天子之政，巡狩四方，制礼定刑 向帝尧建言，请行流、放、迁、殛四罪，天下咸服 受尧禅让摄行天子之政，尧崩后践天子位，是为帝舜 名重华，颛顼七世孙，自穷蝉以下皆为庶人 顺事父、后母与弟象，虽常遭父欲杀仍笃谨不懈 冀州人，耕渔陶作，处家庭险境仍尽孝道 以孝闻名，被尧考察并历经瞽叟与象的谋害而幸免，终试五典百官皆治 举用八恺主后土、八元布五教于四方，内平外成 宾于四门，流放四凶族于四裔，使四门得以清明 摄政后继承尧位，分职群臣，治理天下 天下明德皆自其始，四海之内咸戴其功 二十以孝闻，六十一践帝位，南巡崩于苍梧，葬于九疑 国号有虞，与黄帝同姓，五帝之一 长老往往称其处，与黄帝、尧并提"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('a387e3b7-5ae1-4869-84ef-6d4f6cb61947', 'u5b54-u5b50', '{"zh-Hans": "孔子"}'::jsonb, '春秋', 'historical', 'ai_inferred', NULL, NULL, '{"zh-Hans": "所传宰予问五帝德及帝系姓，儒者或不传"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('73d7a713-158d-4b92-8de0-f130c267297e', 'u9a69-u515c', '{"zh-Hans": "驩兜"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "向尧举荐共工，被尧否定 向尧进言推荐共工，后被舜放逐于崇山以变南蛮"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 契 (xie)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('10ccab31-8acf-4d89-9e85-accc4eda7787', 'xie', '{"zh-Hans": "契"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "受命为司徒，敬敷五教以亲百姓 主掌司徒，使百姓亲睦和谐 商之始祖，姓子氏"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
...
-- Person: 尧 (yao)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('2da772b8-3c0b-4e13-9452-5e85ae34bf26', 'yao', '{"zh-Hans": "尧"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "帝喾与陈锋氏女之子，兄挚不善后继位，是为帝尧 仁德如天、智慧如神，明德亲族、和合万国的上古圣王 询问可用之人治水，先后否定丹朱、共工，最终听从四岳建议用鲧 在位七十载，询问四岳可继位者，决定以二女妻舜以试其德 考察舜三年后，召舜禅让帝位 年老后命舜摄行天子之政以观天命 不认可共工与鲧，但迫于四岳强请而试用，后听舜建言行四罪之罚 在位七十年得舜，禅位于舜，崩后百姓悲哀如丧父母 问可用之人，以二女妻舜、赐衣琴牛羊，并试舜以五典百官 在位时未能举用八恺、八元，留待舜来举用 在位时三凶为患，未能驱逐，至舜时方得流放 知舜可授天下，使舜摄政，后崩 举舜摄政，崩后由舜继帝位 国号陶唐，五帝之一 尚书独载尧以来，长老往往称其处"}'::jsonb) ON CONFLICT (slug) DO NOTHING;

-- Person: 益 (yi)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('ea880e29-01ac-40ed-b4f3-5f1f9da8814a', 'yi', '{"zh-Hans": "益"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "受命为朕虞，掌草木鸟兽，让于朱虎、熊罴 主掌山泽虞衡，开辟山泽资源"}'::jsonb) ON CONFLICT (slug) DO NOTHING;

-- Person: 禹 (yu)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('95638bf0-ec39-42c0-a74b-f101d1d22f58', 'yu', '{"zh-Hans": "禹"}'::jsonb, '夏', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "被举为司空，受命平治水土 功绩最大，披山通泽决河定州，兴九招之乐，致凤皇来翔 被舜荐于天，舜崩后诸侯归之，终践天子位 国号夏后，别氏姓姒，开夏代"}'::jsonb) ON CONFLICT (slug) DO NOTHING;

-- Person: 颛顼 (zhuan-xu)
INSERT INTO persons (id, slug, name, dynasty, reality_status, provenance_tier, birth_date, death_date, biography) VALUES ('c26a5df8-35d3-4339-a520-c56f3fe26b11', 'zhuan-xu', '{"zh-Hans": "颛顼"}'::jsonb, '上古', 'legendary', 'ai_inferred', NULL, NULL, '{"zh-Hans": "昌意之子，有圣德，黄帝崩后即位为帝颛顼 黄帝之孙、昌意之子，治理四方，教化万民，祭祀鬼神 生子穷蝉，崩后由高辛继位 帝喾之族伯，帝喾为其族子 穷蝉之父，昌意之子，舜之六世祖 有才子八人称''八恺''，世代传承其美名 其不才子被天下称为梼杌，为四凶之一的来源氏族首领 国号高阳，五帝之一"}'::jsonb) ON CONFLICT (slug) DO NOTHING;
